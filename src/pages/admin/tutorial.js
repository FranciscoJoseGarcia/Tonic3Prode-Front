        ...
        {language === "es" ? (
          <>
            ...
            <ol>
              ...
              <li>Resultados:</li>
              <p>
                Teniendo acceso a los resultados del torneo, cargará los mismos
                en el panel de RESULTADOS
                <br />
                Se tendrán en cuenta las etapas en las que se encuentra el
                torneo <br />
              </p>
              <li>Premios:</li>
              <p>
                Tendrá la posibilidad de cargar los premios correspondientes a
                los futuros ganadores del 1º, 2º y 3º puesto
                <br />
                Tendrá la responsabilidad de contactarse con los ganadores de
                los debidos premios al momento siguiente de obtener los
                resultados una vez culminado dicho torneo <br />
              </p>
              <li>Edición:</li>
              <p>
          ...
          <>
            ...
            <ol>
              ...
              <p>
                ...
                where they will select the start and end dates of the
                tournament.
                <br />
              ...
              <li>Results:</li>
              <p>
                Having access to the tournament results, they will enter them
              ...
              <p>
                ...
                <br />
                They will be responsible for contacting the winners of the
                prizes immediately after obtaining the results once the
          ...
          <>
            ...
            <ol>
              ...
              <p>
                ...
                <br />
                Terá a responsabilidade de entrar em contato com os vencedores
                dos prêmios devidos logo após obter os resultados assim que o
                torneio tenha terminado. <br />
              </p>
              <li>Edição:</li>
              <p>
                ...
                <br />
                Pode editar resultados de partidas já jogadas em caso de
                equívoco
                <br />
              </p>
            </ol>
